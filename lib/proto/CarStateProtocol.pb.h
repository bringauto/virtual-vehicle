...
// string route = 3;
inline void CarCommand::clear_route() {
  route_.ClearToEmpty();
}
inline const std::string& CarCommand::route() const {
  // @@protoc_insertion_point(field_get:CarStateProtocol.CarCommand.route)
  return _internal_route();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void CarCommand::set_route(ArgT0&& arg0, ArgT... args) {
 
 route_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:CarStateProtocol.CarCommand.route)
}
inline std::string* CarCommand::mutable_route() {
  std::string* _s = _internal_mutable_route();
  // @@protoc_insertion_point(field_mutable:CarStateProtocol.CarCommand.route)
  return _s;
}
inline const std::string& CarCommand::_internal_route() const {
  return route_.Get();
}
inline void CarCommand::_internal_set_route(const std::string& value) {
  
  route_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArenaForAllocation());
}
inline std::string* CarCommand::_internal_mutable_route() {
  
  return route_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArenaForAllocation());
}
inline std::string* CarCommand::release_route() {
  // @@protoc_insertion_point(field_release:CarStateProtocol.CarCommand.route)
  return route_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
}
inline void CarCommand::set_allocated_route(std::string* route) {
  if (route != nullptr) {
