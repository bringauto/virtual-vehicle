...
const std::string statusMessagePeriod_ { "period-ms" };
...
const std::string osmStopWaitTime_ { "wait-at-stop-s" };
const std::string osmSpeedOverride_ { "speed-override" };
const std::string osmSpeedOverrideMs_ { "speed-override-mps" };
...
const std::string stopRadius_ { "stop-radius-m" };
