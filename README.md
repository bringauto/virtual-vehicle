...
Virtual vehicle simulates robot movement on a map fulfilling orders from Fleet Management.
...
- Non-trivial set of cars. Each of them may have own route
- Each car reacts on orders from Fleet Management
